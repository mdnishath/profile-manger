"""
Gmail Bot - Step 3 (Google Maps Review Management)
Entry point — delegates all work to step3/ and shared/ modules.
"""

import sys
from step3.runner import GmailBotWorker
...
def start_production_processing(excel_file, num_workers=5):
    """Start Step 3 multi-worker processing."""
    _run(
        excel_file=excel_file,
        num_workers=num_workers,
        worker_class=GmailBotWorker,
        step_banner='GMAIL BOT - STEP 3 (Google Maps Review Management)',
        step_name='step3',
    )
